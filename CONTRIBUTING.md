# Contributing to Trip Commander

Welcome to the Trip Commander project!

First off, thank you for considering contributing to Trip Commander application . It's people like you that make the open-source community such an amazing place to learn, inspire, and create.

This project  is built using the **MERN Stack** (MongoDB, Express, React, Node.js). We welcome contributors of all skill levels, from beginners to experienced developers.
